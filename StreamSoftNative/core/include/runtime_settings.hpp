...
// Mirrors softforstream/runtime_settings.py — same fields, same JSON file
// format (runtime_settings.json), same merge-with-defaults-on-load behavior.
